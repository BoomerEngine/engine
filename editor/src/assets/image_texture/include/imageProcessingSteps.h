...
namespace rendering
{
    ...
    class ASSETS_IMAGE_TEXTURE_API IImageProcessingStep : public base::IObject
    {
    ...
    class ASSETS_IMAGE_TEXTURE_API ImageProcessingStep_ChannelRemap : public IImageProcessingStep
    {
