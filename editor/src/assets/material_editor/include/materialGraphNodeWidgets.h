...
namespace ed
{
    ...
    class ASSETS_MATERIAL_EDITOR_API MaterialGraphConstantScalarWidget : public ui::IGraphNodeInnerWidget
    {
    ...
    // constant scalar editor
    class ASSETS_MATERIAL_EDITOR_API MaterialGraphConstantColorWidget : public ui::IGraphNodeInnerWidget
    {
