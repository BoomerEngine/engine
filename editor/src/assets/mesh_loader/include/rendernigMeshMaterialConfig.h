...
namespace rendering
{
    ...
    class ASSETS_MESH_LOADER_API MeshMaterialConfig : public base::res::ResourceConfiguration
    {
        RTTI_DECLARE_VIRTUAL_CLASS(MeshMaterialConfig, base::res::ResourceConfiguration);
