...
namespace ed
{
    ...
    /// gizmo host
    class ASSETS_GIZMOS_API IGizmoHost : public base::NoCopy
    {
    public:
        virtual ~IGizmoHost();
    ...
    class ASSETS_GIZMOS_API GizmoGroup : public base::IReferencable
    {
    public:
    ...
    extern ASSETS_GIZMOS_API GizmoGroupPtr CreateTranslationGizmos(const IGizmoHost* host, uint8_t axisMask = 7);
