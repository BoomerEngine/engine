...
namespace base
{
    namespace graph
    {
        ...
        /// socket description
        struct BASE_GRAPH_API BlockSocketStyleInfo
        {
        ...
        struct BASE_GRAPH_API BlockLayoutBuilder
        {
        ...
        class BASE_GRAPH_API Block : public IObject
        {
        ...
        public:
            ...
            virtual void buildLayout(base::graph::BlockLayoutBuilder& builder) const;
        ...
        class BASE_GRAPH_API BlockShapeMetadata : public rtti::IMetadata
        {
        ...
        class BASE_GRAPH_API BlockInfoMetadata : public rtti::IMetadata
        {
        ...
        class BASE_GRAPH_API BlockTitleColorMetadata : public rtti::IMetadata
        {
        ...
        // meta data with the block title color
        class BASE_GRAPH_API BlockStyleNameMetadata : public rtti::IMetadata
        {
        ...
        class BASE_GRAPH_API BlockBorderColorMetadata : public rtti::IMetadata
        {
        ...
        class BASE_GRAPH_API BlockHelpMetadata : public rtti::IMetadata
        {
