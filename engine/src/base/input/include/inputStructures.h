...
namespace base
{
    namespace input
    {
        ...
        class BASE_INPUT_API BaseEvent : public IReferencable
        {
		...
		/// key flags
		class BASE_INPUT_API BaseKeyFlags
		{
        ...
        /// mouse event
        class BASE_INPUT_API MouseClickEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API MouseMovementEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API MouseCaptureLostEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API CharEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API KeyEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API AxisEvent : public BaseEvent
        {
        ...
        class BASE_INPUT_API DragDropEvent : public BaseEvent
        {
