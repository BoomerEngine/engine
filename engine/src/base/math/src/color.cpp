...
namespace base
{
    ...
    Color Color::FromVectorLinear(const base::Vector4 &other)
    {
        struct
        {
            Color ret;
    ...
    {
        return base::Vector3(0.299f, 0.587f, 0.114f) | toVectorSRGB().xyz();
    }
    ...
    Color Color::FromVectorSRGBFast(const base::Vector4 &other)
    {
        Color ret;
