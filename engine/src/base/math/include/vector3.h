...
namespace base
{
    ...
    public:
        ...
        //! get random vector
        static Vector3 Rand(float min=0.0f, float max=1.0f);
    ...
    extern BASE_MATH_API Vector3 Snap(const Vector3 &a, float grid);
    ...
    extern BASE_MATH_API Vector3 Clamp(const Vector3 &a, float minF, float maxF);
