...
#include "base/object/include/rttiNativeClassType.h"
#include "base/object/include/rttiCustomType.h"
...
#define RTTI_BEGIN_TYPE_NATIVE_CLASS(_type)\
    static base::rtti::NativeClass* theClass##_type = nullptr;\
    ...
    void InitType_##_type() {\
        typedef _type TType;\
        theClass##_type->baseClass(base::reflection::ClassID<typename _type::TBaseClass>());\
        base::reflection::ClassBuilder builder(theClass##_type);\
...
#define RTTI_BEGIN_TYPE_ENUM(_type)\
    ...
    void InitType_##_type() {\
        typedef _type TType;\
        base::reflection::EnumBuilder builder(theEnum##_type);
...
#define RTTI_BEGIN_TYPE_BITFIELD(_type)\
    ...
    void InitType_##_type() {\
       typedef _type TType;\
       base::reflection::BitFieldBuilder builder(theBitfield##_type, _type::FLAGS_TYPE);
...
#define RTTI_BEGIN_CUSTOM_TYPE(_type)\
    ...
    void CreateType_##_type(const char* name) {\
     ...
     void InitType_##_type() {\
       typedef _type TType;\
       base::reflection::CustomTypeBuilder builder(theCustomType##_type);
...
#define RTTI_PROPERTY_VIRTUAL(_name, _type, _offset)\
    builder.addProperty(_name, base::reflection::GetTypeObject<_type>(), _offset)
...
#define RTTI_GLOBAL_FUNCTION(_func, _name)\
    void RegisterGlobalFunc_##_func() {\
        base::reflection::FunctionBuilder funcBuilder(_name);\
        base::reflection::FunctionBuilderStatic globalFuncBuilder(funcBuilder);\
