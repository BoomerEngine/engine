...
namespace base
{
    namespace font
    {
        ...
        class BitmapFontCooker : public res::IResourceCooker
        {
            RTTI_DECLARE_VIRTUAL_CLASS(BitmapFontCooker, res::IResourceCooker);
        ...
        RTTI_BEGIN_TYPE_CLASS(BitmapFontCooker);
            ...
            RTTI_METADATA(base::res::ResourceSourceFormatMetadata).addSourceClass<Font>();
