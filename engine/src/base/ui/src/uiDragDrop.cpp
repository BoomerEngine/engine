...
namespace ui
{
    ...
    DragDropData_String::DragDropData_String(const base::StringBuf& data)
        : m_data(data)
    {}
    ...
    void IDragDropHandler::handleMouseWheel(const base::input::MouseMovementEvent &evt, float delta)
    {
    }

    IDragDropHandler::UpdateResult IDragDropHandler::processMouseMovement(const base::input::MouseMovementEvent& evt)
    {
