...
namespace ui
{
    ...
    struct BASE_UI_API InputActionResult
    {
    public:
    ...
    class BASE_UI_API IInputAction : public base::IReferencable
    {
    ...
    public:
        ...
        /// Update mouse cursor
        virtual void onUpdateCursor(base::input::CursorType& outCursorType);
        ...
        /// Handle key event
        virtual InputActionResult onKeyEvent(const base::input::KeyEvent& evt);

        /// Handle mouse click
        virtual InputActionResult onMouseEvent(const base::input::MouseClickEvent& evt, const ElementWeakPtr& hoveredElement);

        /// Handle mouse movement
        virtual InputActionResult onMouseMovement(const base::input::MouseMovementEvent& evt, const ElementWeakPtr& hoveredElement);
        ...
        static base::RefPtr<IInputAction> CONSUME();
    ...
    class BASE_UI_API MouseInputAction : public IInputAction
    {
    public:
        MouseInputAction(IElement* ptr, const base::input::KeyCode mouseCode, bool cancelWithEscape = true);
    ...
    private:
        base::input::KeyCode m_controllingButton;
