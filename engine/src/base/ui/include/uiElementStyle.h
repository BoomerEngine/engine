...
namespace ui
{
    ...
    class BASE_UI_API StyleStack : public base::NoCopy
    {
    public:
    ...
    private:
        ...
        typedef base::InplaceArray<Element, 64> TParentHierarchy;
        TParentHierarchy m_stack;

        base::InplaceArray<const style::Library*, 4> m_styleLibraries;

        typedef base::InplaceArray<const style::SelectorMatch*, 256> TSelectorMatches;
