...
namespace base
{
    ...
    namespace res
    {
        ...
        class BASE_RESOURCES_API ResourcePath
        {
        public:
        ...
        class BASE_RESOURCES_API ResourceKey
        {
        public:
            INLINE ResourceKey()
                : m_class(nullptr)
        ...
        class BASE_RESOURCES_API ResourcePathBuilder : public base::NoCopy
        {
        public:
            ResourcePathBuilder();
        ...
        extern BASE_RESOURCES_API bool ApplyRelativePath(StringView<char> contextPath, StringView<char> relativePath, StringBuf& outPath);
