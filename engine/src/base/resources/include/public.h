...
// glue code
#include "base_resources_glue.inl"
...
namespace base
{
    ...
    extern BASE_RESOURCES_API CAN_YIELD res::BaseReference LoadResource(const res::ResourceKey& key);
    ...
    extern BASE_RESOURCES_API void LoadResourceAsync(const res::ResourceKey& key, const std::function<void(const res::BaseReference&)>& funcLoaded);
    ...
    // clone object
    extern BASE_RESOURCES_API ObjectPtr CloneObjectUntyped(const IObject* object, const IObject* newParent = nullptr, res::IResourceLoader* loader = nullptr, SpecificClassType<IObject> mutatedClass = nullptr);
    ...
    extern BASE_RESOURCES_API Buffer SaveObjectToBuffer(const IObject* object);

    // load object from binary buffer
    extern BASE_RESOURCES_API ObjectPtr LoadObjectFromBuffer(const void* data, uint32_t size, res::IResourceLoader* loader=nullptr, SpecificClassType<IObject> mutatedClass = nullptr);
