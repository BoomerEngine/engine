...
namespace base
{
    namespace res
    {
        ...
        class BASE_RESOURCES_API IResourceCookerInterface : public IProgressTracker
        {
        public:
        ...
        class BASE_RESOURCES_API CookerErrorReporter : public parser::IErrorReporter
        {
        public:
        ...
        class BASE_RESOURCES_API CookerIncludeHandler : public parser::IIncludeHandler
        {
        public:
