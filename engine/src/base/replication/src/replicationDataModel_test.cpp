...
TEST(DataModel, EncodeWritesPathWhenSet)
{
    ...
    test::TestReplicatedStruct_ResRef s;
    //s.m_path.set(res::ResourceKey(res::ResourcePath("dupa.txt"), res::ITextResource::GetStaticClass()));
...
TEST(DataModelTransmit, ResourceRef)
{
    ...
    test::TestReplicatedStruct_ResRef s, out;
    //s.m_path.set(res::ResourceKey(res::ResourcePath("dupa.txt"), base::res::IResource::GetStaticClass()));
