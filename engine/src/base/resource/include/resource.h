...
namespace base
{
    namespace res
    {
        ...
        class BASE_RESOURCE_API ResourceBakedOnlyMetadata : public rtti::IMetadata
        {
        ...
        class BASE_RESOURCE_API ResourceManifestExtensionMetadata : public rtti::IMetadata
        {
        ...
        class BASE_RESOURCE_API ITextResource : public IResource
        {
        ...
        class BASE_RESOURCE_API RawTextData : public IResource
        {
       ...
       // NOTE: any file extension is always cookable into this format
       // this format allows "classic" cooker-less processing of data when all the loading code is engine-side
        class BASE_RESOURCE_API RawBinaryData : public IResource
        {
        ...
        class BASE_RESOURCE_API ResourceCookerBakingOnlyMetadata : public rtti::IMetadata
        {
        ...
        class BASE_RESOURCE_API IResourceManifest : public res::ITextResource
        {
