...
namespace base
{
    ...
    struct BASE_RESOURCE_API ObjectIndirectTemplateProperty
    {
    ...
    class BASE_RESOURCE_API ObjectIndirectTemplate : public IObject
    {
    ...
    public:
        ...
        void templateClass(base::ClassType cls, bool callEvent = true);
