...
namespace base
{
    namespace depot
    {
        ...
        struct BASE_DEPOT_API PackageManifestScriptsReference
        {
        ...
        struct BASE_DEPOT_API PackageManifestDependency
        {
        ...
        class BASE_DEPOT_API PackageManifest : public res::ITextResource
        {
