...
namespace base
{
    namespace depot
    {
        ...
        class BASE_DEPOT_API DepotFileSystem : public base::NoCopy
        {
        public:
        ...
        class BASE_DEPOT_API IDepotObserver : public base::NoCopy
        {
        public:
        ...
        class BASE_DEPOT_API DepotStructure : public NoCopy
        {
        public:
            DepotStructure();
