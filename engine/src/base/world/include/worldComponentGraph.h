...
namespace base
{
    namespace world
    {
        ...
        private:
            ...
            Array<LinkEntry> m_links;
            Array<short> m_linkIndices;
            Array<OrderEntry> m_order;
            bool m_updateOrderInvalid = false;

            InplaceArray<Component*, 2> m_tempIncomingList;
            InplaceArray<Component*, 2> m_tempOutgoingList;
