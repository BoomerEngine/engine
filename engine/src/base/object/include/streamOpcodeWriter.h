...
namespace base
{
    namespace stream
    {
        ...
        struct BASE_OBJECT_API OpcodeWriterResourceReference
        {
        ...
        struct BASE_OBJECT_API OpcodeWriterReferences : public NoCopy
        {
        ...
        class BASE_OBJECT_API OpcodeWriter : public NoCopy
        {
        public:
