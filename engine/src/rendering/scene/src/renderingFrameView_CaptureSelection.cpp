...
namespace rendering
{
    namespace scene
    {
        ...
        void FrameViewCaptureSelection::initializeCommandStreams(command::CommandWriter& cmd, FrameViewCaptureSelectionRecorder& rec)
        {
            // trigger capture
            ...
            {
                command::CommandWriterBlock block(cmd, "Fragments");
