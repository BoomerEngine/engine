...
#pragma pack(1)
    ...
    struct RENDERING_DRIVER_API BlendState
    {
    ...
    struct RENDERING_DRIVER_API StencilSideState
    {
    ...
    /// stencil op state
    struct RENDERING_DRIVER_API StencilState
    {
        bool enabled = 0;
    ...
    /// culling state
    struct RENDERING_DRIVER_API CullState
    {
    ...
    struct RENDERING_DRIVER_API FillState
    {
    ...
    /// depth testing state
    struct RENDERING_DRIVER_API DepthState
    {
        bool enabled = 0;
        bool writeEnabled = 0;
    ...
    /// depth clip state
    struct RENDERING_DRIVER_API DepthClipState
    {
        bool enabled = false;
        float clipMin = 0.0f;
        float clipMax = 1.0f;
    ...
    /// depth bias state
    struct RENDERING_DRIVER_API DepthBiasState
    {
        bool enabled = 0;
        float constant = 0.0f;
        float slope = 0.0f;
    ...
    struct RENDERING_DRIVER_API PrimitiveAssemblyState
    {
    ...
    /// multisampling state
    struct RENDERING_DRIVER_API MultisampleState
    {
    ...
    /// sampler state
    struct RENDERING_DRIVER_API SamplerState
    {
