...
#pragma pack(1)
    ...
    struct RENDERING_DRIVER_API DataLayoutElement
    {
    ...
    struct RENDERING_DRIVER_API DataLayoutStructure
    {
    ...
    struct RENDERING_DRIVER_API VertexInputLayout
    {
    ...
    struct RENDERING_DRIVER_API VertexInputState
    {
    ...
    struct RENDERING_DRIVER_API ParameterResourceLayoutElement
    {
    ...
    struct RENDERING_DRIVER_API ParameterResourceLayoutTable
    {
        PipelineIndex name = INVALID_PIPELINE_INDEX;
    ...
    struct RENDERING_DRIVER_API ParameterBindingState
    {
    ...
    struct RENDERING_DRIVER_API ShaderBundle
    {
    ...
    struct RENDERING_DRIVER_API ShaderBlob
    {
...
#pragma pack(pop)
    ...
    class RENDERING_DRIVER_API ShaderLibraryData : public base::IObject
    {
    ...
    class RENDERING_DRIVER_API ShaderLibrary : public base::res::IResource, public IDeviceObject
    {
        RTTI_DECLARE_VIRTUAL_CLASS(ShaderLibrary, base::res::IResource);

    public:
        ShaderLibrary();
        ShaderLibrary(const ShaderLibraryDataPtr& dataPtr); // assumes index 0
        ...
        // resolve for use, fails if we are invalid
        bool resolve(ObjectID& outShaderLibraryId, PipelineIndex& outPipelineIndex, ShaderLibraryDataPtr* outDataPtr) const;

        // assign data, can happen asynchronously while shader is loading
        void bind(const ShaderLibraryDataPtr& data, PipelineIndex index);
