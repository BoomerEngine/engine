...
namespace rendering
{
    ...
    struct RENDERING_DRIVER_API FrameBufferColorAttachmentInfo : public FrameBufferAttachmentInfo
    {
    ...
    struct RENDERING_DRIVER_API FrameBufferDepthAttachmentInfo : public FrameBufferAttachmentInfo
    {
    ...
    class RENDERING_DRIVER_API FrameBuffer
    {
    public:
    ...
    struct RENDERING_DRIVER_API FrameBufferViewportState
    {
