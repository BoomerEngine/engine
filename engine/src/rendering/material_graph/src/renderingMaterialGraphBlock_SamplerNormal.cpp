...
namespace rendering
{
    ...
    public:
        ...
        virtual void buildLayout(base::graph::BlockLayoutBuilder& builder) const override
        {
            ...
            builder.socket("Texture"_id, MaterialInputSocket().tag("TEXTURE"_id).color(base::Color::FIREBRICK));
        }
        ...
        virtual CodeChunk compile(MaterialStageCompiler& compiler, base::StringID outputName) const override
        {
            ...
            auto textureXY = CodeChunk(CodeChunkType::Numerical2, base::TempString("texture({}, {}).xy", sampler, uv));
    ...
    RTTI_BEGIN_TYPE_CLASS(MaterialGraphBlock_SamplerNormal);
        RTTI_METADATA(base::graph::BlockInfoMetadata).title("SamplerNormal").group("Samplers");
