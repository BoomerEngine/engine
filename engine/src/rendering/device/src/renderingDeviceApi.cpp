...
namespace rendering
{
    ...
    BufferObject::BufferObject(const BufferView& view, IDeviceObjectHandler* impl)
        : IDeviceObject(view.id(), impl)
        , m_view(view)
    {}
    ...
    ImageObject::ImageObject(const ImageView& view, IDeviceObjectHandler* impl)
        : IDeviceObject(view.id(), impl)
        , m_view(view)
    {}
