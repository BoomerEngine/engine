...
namespace rendering
{
    namespace test
    {
        ...
        void RenderingTest_RenderToCube::render(command::CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* backBufferDepth)
        {
			// rotate the teapots
