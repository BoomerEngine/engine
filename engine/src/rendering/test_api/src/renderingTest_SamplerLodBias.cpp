...
namespace rendering
{
    namespace test
    {
        ...
        void RenderingTest_SamplerLodBias::initialize()
        {
            ...
            m_shaders = loadGraphicsShader("SamplerFiltering.csl", outputLayoutNoDepth());
        }

        void RenderingTest_SamplerLodBias::render(command::CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* depth)
        {
            FrameBuffer fb;
