...
namespace rendering
{
    namespace test
    {
        ...
        void RenderingTest_MultipleImageUpdates::render(command::CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* backBufferDepthView)
        {
            auto GRID_SIZE = 16;
