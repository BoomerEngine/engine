...
/*
 ...
 - 2019/10/22 (1.74) - removed redirecting functions/enums that were marked obsolete in 1.52 (October 2017):
                       ...
                       - ImFont::FontGlyph                       -> use ImFontGlyph
 ...
 - 2017/09/26 (1.52) - renamed ImFont::FontGlyph to ImFontGlyph. Kept redirection typedef (will obsolete).
 ...
 - 2014/09/24 (1.12) - moved IM_MALLOC/IM_REALLOC/IM_FREE preprocessor defines to IO.ImGuiAllocFn/IO.MemReallocFn/IO.ImGuiFreeFn
...
#pragma clang diagnostic ignored "-Wexit-time-destructors"  // warning : declaration requires an exit-time destructor       // exit-time destruction order is undefined. if ImGuiFree() leads to users code that has been disabled before exit it might cause problems. ImGui coding style welcomes static/globals.
...
// Memory allocated with IM_ALLOC(), must be freed by user using IM_FREE() == ImGui::ImGuiFree()
