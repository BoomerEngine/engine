...
class ENGINE_WORLD_API IWorldSystem : public IObject
{
    RTTI_DECLARE_POOL(POOL_WORLD_SYSTEM)
    RTTI_DECLARE_VIRTUAL_CLASS(IWorldSystem, IObject);
...
public:
    ...
    virtual void handleRendering(rendering::FrameParams& info);
