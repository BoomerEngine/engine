...
public:
    ...
    INLINE const RawEntityPtr& root() const { return m_root; }

    void setup(RawEntity* root);

    EntityPtr compile(StringID appearance, Array<EntityPtr>& outAllEntities, bool loadImports) const;
