...
#include "build.h"
#include "renderingSceneObject_Mesh.h"
...
#include "engine/mesh/include/renderingMeshChunkProxy.h"
#include "engine/material/include/renderingMaterial.h"
#include "engine/material/include/renderingMaterialInstance.h"
#include "engine/material/include/renderingMaterialRuntimeProxy.h"
#include "engine/material/include/renderingMaterialRuntimeTemplate.h"
...
void ObjectManagerMesh::renderChunkListStandalone(gpu::CommandWriter& cmd, const Array<VisibleStandaloneChunk>& chunks, MaterialPass pass) const
{
    const auto* objects = m_localObjects.values().typedData();
