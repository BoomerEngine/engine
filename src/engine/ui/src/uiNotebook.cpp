...
StringBuf Notebook::tabTitle(IElement* tab)
{
    return tab->evalStyleValue<StringBuf>("title"_id, "Tab");
}
...
ButtonPtr Notebook::createHeaderButtonForTab(IElement* tab)
{
    ...
    tabButton->bind(EVENT_CONTEXT_MENU) = [this](Button* button, Position position)
    {
