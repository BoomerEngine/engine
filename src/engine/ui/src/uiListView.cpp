...
void ListView::modelItemsAdded(const ModelIndex& parent, const Array<ModelIndex>& items)
{
...
void ListView::modelItemsRemoved(const ModelIndex& parent, const Array<ModelIndex>& items)
{
