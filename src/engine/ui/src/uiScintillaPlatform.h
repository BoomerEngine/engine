...
namespace Scintilla
{
    ...
    struct FontInfo : public boomer::NoCopy
    {
    ...
    class FontCache : public boomer::ISingleton
    {
    ...
    private:
        ...
        boomer::HashMap<uint64_t, const FontInfo*> m_fonts;
        boomer::SpinLock m_lock;
    };

    //--

    static INLINE boomer::Rect ToRect(const PRectangle &rc)
    {
        return boomer::Rect(rc.left, rc.top, rc.right, rc.bottom);
    }

    static INLINE PRectangle FromRect(const boomer::Rect &rc)
    {
    ...
    static INLINE PRectangle FromRect(const boomer::ui::ElementArea& rc)
    {
    ...
    static INLINE boomer::Color ToColor(const ColourDesired& color, int alpha = 255)
    {
        return boomer::Color(color.GetRed(), color.GetGreen(), color.GetBlue(), alpha);
    }

    //--

    class IWindowInterface : public boomer::NoCopy
    {
    public:
