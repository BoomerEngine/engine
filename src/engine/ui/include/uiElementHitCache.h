...
class ENGINE_UI_API HitCache : public NoCopy
{
public:
    HitCache();
    ...
    void traceAllElements(const Position& absolutePosition, Array<ElementPtr>& outAllElements) const;
...
private:
    ...
    struct GridCell
    {
        typedef Array<uint16_t> TEntries;
        TEntries m_entries;
    };
