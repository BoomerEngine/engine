...
/// message box setup
class ENGINE_UI_API MessageBoxSetup
{
public:
    MessageBoxSetup();
    ...
    StringBuf m_captions[(int)MessageButton::MAX];
    ...
    INLINE MessageBoxSetup& caption(MessageButton button, StringView txt) { m_captions[(int)button] = StringBuf(txt); return *this; }
    ...
    INLINE MessageBoxSetup& title(StringView txt) { m_title = StringBuf(txt); return *this; }
    INLINE MessageBoxSetup& message(StringView txt) { m_message = StringBuf(txt); return *this; }
...
extern ENGINE_UI_API MessageButton ShowMessageBox(IElement* parent, const MessageBoxSetup& setup);
