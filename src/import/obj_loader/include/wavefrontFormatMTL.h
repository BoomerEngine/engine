...
namespace wavefront
{
    ...
    class IMPORT_OBJ_LOADER_API FormatMTL : public base::res::ISourceAsset
    {
    ...
    extern IMPORT_OBJ_LOADER_API FormatMTLPtr LoadMaterials(base::StringView contextName, const void* data, uint64_t dataSize);
