...
RTTI_BEGIN_TYPE_CLASS(SourceAssetOBJ);
...
SourceAssetOBJ::SourceAssetOBJ()
{}

SourceAssetOBJ::SourceAssetOBJ(const SourceAssetOBJ& other)
{
    copy(other);
}

void SourceAssetOBJ::copy(const SourceAssetOBJ& other)
{
...
uint64_t SourceAssetOBJ::calcMemoryUsage() const
{
...
void SourceAssetOBJ::transformSimple(float scale, bool flipYZ)
{
