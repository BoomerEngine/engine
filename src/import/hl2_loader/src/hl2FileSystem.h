...
namespace hl2
{
    ...
    public:
        ...
        virtual bool ownsFile(base::StringView rawFilePath) const override final;
        virtual bool contextName(base::StringView rawFilePath, base::StringBuf& outContextName) const override final;
        virtual bool timestamp(base::StringView rawFilePath, base::io::TimeStamp& outTimestamp) const override final;
        virtual bool absolutePath(base::StringView rawFilePath, base::StringBuf& outAbsolutePath) const override final;
        virtual bool enumDirectoriesAtPath(base::StringView rawDirectoryPath, const std::function<bool(base::StringView)>& enumFunc) const override final;
        virtual bool enumFilesAtPath(base::StringView rawDirectoryPath, const std::function<bool(base::StringView)>& enumFunc) const override final;
