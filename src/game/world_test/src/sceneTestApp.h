...
protected:
    ...
    void prepareSceneCommandBuffers(rendering::GPUCommandWriter& cmd, const rendering::scene::FrameCompositionTarget& target);
    void prepareCanvasCommandBuffers(rendering::GPUCommandWriter& cmd, const rendering::scene::FrameCompositionTarget& target);
