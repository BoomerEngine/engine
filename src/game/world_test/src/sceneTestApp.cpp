...
void SceneTestProject::update()
{
    ...
    {
        rendering::GPUCommandWriter cmd("TestScene");
...
void SceneTestProject::prepareSceneCommandBuffers(rendering::GPUCommandWriter& cmd, const rendering::scene::FrameCompositionTarget& target)
{
...
void SceneTestProject::prepareCanvasCommandBuffers(rendering::GPUCommandWriter& cmd, const rendering::scene::FrameCompositionTarget& target)
{
