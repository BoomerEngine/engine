...
struct CORE_IMAGE_API FreeImageLoadedData : public IReferencable
{
    uint32_t width = 0;
    uint32_t height = 0;
...
extern CORE_IMAGE_API RefPtr<FreeImageLoadedData> LoadImageWithFreeImage(const void* data, uint64_t dataSize);
