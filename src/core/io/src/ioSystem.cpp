...
#include "core/containers/include/utf8StringFunctions.h"
    ...
    typedef boomer::io::prv::WinIOSystem NativeHandlerClass;
#elif defined(PLATFORM_POSIX)
    #include "ioSystemPOSIX.h"
    typedef boomer::io::prv::POSIXIOSystem NativeHandlerClass;
#else
...
{
    NativeHandlerClass::GetInstance().findFiles(absoluteFilePath, searchPattern, [&outAbsoluteFiles](StringView fullPath, StringView name)
        {
...
bool ShowFileOpenDialog(uint64_t nativeWindowHandle, bool allowMultiple, const Array<FileFormat>& formats, Array<StringBuf>& outPaths, OpenSavePersistentData& persistentData)
{
