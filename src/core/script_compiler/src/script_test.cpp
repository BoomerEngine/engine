...
class ScriptFixture : public ::testing::Test
    ...
    static Vector3 GFunctionVectorIn;
    static Vector3 GFunctionVectorIn2;

    void TestVectorFunctionIn(const Vector3& str)
    {
        GFunctionVectorIn = str;
    }

    void TestVectorFunctionIn2(const Vector3& str)
    {
    ...
    static RefPtr<NativeScriptObject> GFunctionObjectPtr;
    ...
    TEST_F(ScriptFixture, NativeClassTest)
    {
        ...
        // create object
        auto ptr = RefNew<NativeScriptObject>();
        ...
        UntypedRefWeakPtr weakRef = GFunctionObjectPtr;
