...
#include "core/reflection/include/reflectionClassBuilder.h"
...
class CORE_APP_API CommandLine final : public IBaseCommandLine
{
...
class CORE_APP_API CommandLineUnpackedAnsi : public NoCopy
{
public:
    int m_argc;
    char** m_argv;
