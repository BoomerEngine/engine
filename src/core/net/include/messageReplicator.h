...
class CORE_NET_API IMessageReplicatorDataSink : public NoCopy
{
public:
...
class CORE_NET_API IMessageReplicatorDispatcher : public NoCopy
{
public:
...
/// NOTE:
class CORE_NET_API MessageReplicator : public NoCopy
{
public:
