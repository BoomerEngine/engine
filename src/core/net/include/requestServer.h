...
class CORE_NET_API Connection : public IReferencable
{
public:
...
/// incoming request
class CORE_NET_API IncomingRequest : public IReferencable
{
public:
...
class CORE_NET_API RequestServer : public IReferencable, public socket::tcp::IServerHandler
{
public:
    RequestServer();
    ~RequestServer();
