...
class CORE_FIBERS_API Scheduler : public ISingleton
{
...
using Fibers = fibers::Scheduler;

// the "GO" style runner
extern CORE_FIBERS_API fibers::FiberBuilder RunFiber(const char* name = "InlineFiber");

// run a child fiber
extern CORE_FIBERS_API fibers::FiberBuilder RunChildFiber(const char* name = "ChildFiber");
...
extern CORE_FIBERS_API fibers::FiberBuilder RunSync(const char* name = "Sync");
