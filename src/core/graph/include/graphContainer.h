...
struct CORE_GRAPH_API PersistentConnection
{
...
struct CORE_GRAPH_API PersistentBlockState
{
...
struct CORE_GRAPH_API SupprotedBlockConnectionInfo
{
...
class CORE_GRAPH_API Container : public IObject
{
