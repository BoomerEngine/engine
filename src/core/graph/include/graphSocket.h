...
// socket in block
class CORE_GRAPH_API Socket : public IObject
{
...
public:
    ...
    static bool CanConnect(const Socket& from, const Socket& to, const Array<Connection*>* removedConnections=nullptr);
...
private:
    ...
    static bool CheckDuplicates(const Socket& a, const Socket& b, const Array<Connection*>* removedConnections);
    static bool CheckMulticonnections(const Socket& a, const Array<Connection*>* removedConnections);
