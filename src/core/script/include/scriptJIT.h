...
namespace jit
{
    ...
    struct EngineToJIT
    {
        ...
        void (*_fnThrowException)(void* self, const IFunctionStackFrame* frame, const char* file, int line, const char* txt) = nullptr;
        ...
        void (*_fnCall)(void* self, void* context, int funcId, int mode, const IFunctionStackFrame* parentFrame, FunctionCallingParams* params) = nullptr;

        void (*_fnNew)(void* self, const IFunctionStackFrame* parentFrame, const ClassType* classPtr, ObjectPtr* strongPtr);
        ...
        int64_t (*_fnNameToEnum)(void* self, const IFunctionStackFrame* parentFrame, int typeId, StringID enumName);
    ...
    struct JITInit
    {
        ...
        void (*_fnReportExportFunction)(void* self, const char* className, const char* funcName,  uint64_t codeHash, TFunctionJittedWrapperPtr funcPtr) = nullptr;
...
class CORE_SCRIPT_API JITProject : public IReferencable
{
public:
...
private:
    ...
    Array<const Function*> m_functionTable;

    //--

    static void InterfaceLog(void* self, const char* txt);
    static void InterfaceThrowException(void* self, const IFunctionStackFrame* frame, const char* file, int line, const char* txt);
    ...
    static void InterfaceCall(void* self, void* context, int funcId, int mode, const IFunctionStackFrame* parentFrame, FunctionCallingParams* params);
    static void InterfaceNew(void* self, const IFunctionStackFrame* parentFrame, const ClassType*classPtr, ObjectPtr* strongPtr);
    ...
    static int64_t InterfaceNameToEnum(void* self, const IFunctionStackFrame* parentFrame, int typeId, StringID enumName);
...
class CORE_SCRIPT_API IJITNativeTypeInsight : public NoCopy
{
public:
    ...
    struct TypeInfo
    {
        MetaType metaType = MetaType::Void;
...
class CORE_SCRIPT_API IJITCompiler : public IReferencable
{
