...
#define ALLOCA_ALIGNED(x, a) boomer::AlignPtr(alloca((x) + (a) - 1), a);
...
typedef void (*TOpcodePtr)(boomer::script::StackFrame* stack, void* resultPtr) noexcept(true);
#define DECLARE_OPCODE(__opcode) static void op##__opcode(boomer::script::StackFrame* stack, void* resultPtr) noexcept(true)
