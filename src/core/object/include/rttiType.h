...
struct CORE_OBJECT_API TypeSerializationContext : public NoCopy
{
...
class CORE_OBJECT_API IType : public MetadataContainer
{
public:
...
extern CORE_OBJECT_API StringID FormatStrongHandleTypeName(StringID className);
extern CORE_OBJECT_API StringID FormatWeakHandleTypeName(StringID className);
extern CORE_OBJECT_API StringID FormatDynamicArrayTypeName(StringID innerTypeName);
extern CORE_OBJECT_API StringID FormatNativeArrayTypeName(StringID innerTypeName, uint32_t maxSize);
