...
class CORE_OBJECT_API IMetadata : public NoCopy
{
...
/// Metadata container
class CORE_OBJECT_API MetadataContainer : public NoCopy
{
    RTTI_DECLARE_POOL(POOL_RTTI)
...
class CORE_OBJECT_API ShortTypeNameMetadata : public IMetadata
{
public:
