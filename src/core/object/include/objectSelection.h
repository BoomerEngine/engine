...
class CORE_OBJECT_API Selectable
{
public:
    INLINE Selectable() {}
    ...
    {
        return CRC32() << key.m_objectID << key.m_subObjectID;
    }
...
#pragma pack(push)
#pragma pack(2)
struct CORE_OBJECT_API EncodedSelectable
{
    Selectable object;
    uint16_t x = 0;
    uint16_t y = 0;
    ...
    void print(IFormatStream& f) const; // debug print
};
#pragma pack(pop)
