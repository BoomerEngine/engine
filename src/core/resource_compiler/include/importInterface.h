...
class CORE_RESOURCE_COMPILER_API IResourceImporterInterface : public IProgressTracker
{
public:
...
class CORE_RESOURCE_COMPILER_API IResourceImporter : public IReferencable
{
