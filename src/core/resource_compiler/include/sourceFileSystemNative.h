...
public:
    ...
    virtual Buffer loadFileContent(StringView fileSystemPath, TimeStamp& outTimestamp, SourceAssetFingerprint& outFingerprint) const override;
    ...
    virtual CAN_YIELD SourceAssetStatus checkFileStatus(StringView fileSystemPath, const TimeStamp& lastKnownTimestamp, const SourceAssetFingerprint& lastKnownFingerprint, IProgressTracker* progress) const override;
