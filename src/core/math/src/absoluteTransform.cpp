...
AbsolutePosition AbsoluteTransform::transformPointFromSpace(const Vector3 &localPoint) const
{
...
Vector3 AbsoluteTransform::transformPointToSpace(const AbsolutePosition &absolutePosition) const
{
