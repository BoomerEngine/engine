...
#ifdef EIGEN_QUATERNIONCORE_PLUGIN
# include EIGEN_QUATERNIONCORE_PLUGIN
#endif
protected:
...
QuaternionBase<Derived>::operator* (const QuaternionBase<OtherDerived>& other) const
{
  EIGEN_STATIC_ASSERT((internal::is_same<typename Derived::Scalar, typename OtherDerived::Scalar>::value),
   YOU_MIXED_DIFFERENT_NUMERIC_TYPES__YOU_NEED_TO_USE_THE_CAST_METHOD_OF_MATRIXCORE_TO_CAST_NUMERIC_TYPES_EXPLICITLY)
