 ...
 */
    ...
    struct static_assertion<true>
    {
      enum {
        ...
        YOU_MIXED_DIFFERENT_NUMERIC_TYPES__YOU_NEED_TO_USE_THE_CAST_METHOD_OF_MATRIXCORE_TO_CAST_NUMERIC_TYPES_EXPLICITLY=1,
        ...
        INVALID_MATRIXCORE_TEMPLATE_PARAMETERS=1,
