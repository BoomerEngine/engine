...
#ifndef EIGEN_DENSECORE_H
#define EIGEN_DENSECORE_H
...
/** \class DenseBase
  ...
  * \ref TopicCustomizing_Plugins by defining the preprocessor symbol \c EIGEN_DENSECORE_PLUGIN.
  *
...
#define EIGEN_CURRENT_STORAGE_CORE_CLASS Eigen::DenseBase
...
#   ifdef EIGEN_DENSECORE_PLUGIN
#     include EIGEN_DENSECORE_PLUGIN
#   endif
