...
operator*(const EIGEN_CURRENT_STORAGE_CORE_CLASS<OtherDerived> &other) const
{
...
OP(const EIGEN_CURRENT_STORAGE_CORE_CLASS<OtherDerived> &other) const \
{ \
...
OP(const Scalar& s, const EIGEN_CURRENT_STORAGE_CORE_CLASS<Derived>& d) { \
...
polygamma(const EIGEN_CURRENT_STORAGE_CORE_CLASS<DerivedN> &n) const
{
...
zeta(const EIGEN_CURRENT_STORAGE_CORE_CLASS<DerivedQ> &q) const
{
