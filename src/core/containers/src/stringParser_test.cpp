...
namespace testing
{
    ...
    template<>
    INLINE ::std::string PrintToString<boomer::StringView>(const boomer::StringView& value)
    {
        return std::string(value.data(), value.length());
    }

    template<>
    INLINE ::std::string PrintToString<boomer::StringID>(const boomer::StringID& value)
    {
