...
namespace prv
{
    ...
    class CORE_CONTAINERS_API StringDataHolder : public NoCopy
    {
    public:
...
class CORE_CONTAINERS_API StringBuf
{
public:
    INLINE StringBuf()
        : m_data(nullptr)
...
extern CORE_CONTAINERS_API void ReplaceText(IFormatStream& f, StringView templateText, const ReplaceTextPattern* patterns, uint32_t numPatterns);
