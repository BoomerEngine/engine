...
struct CORE_RESOURCE_API SourceDependency
{
...
struct CORE_RESOURCE_API ImportDependency
{
...
struct CORE_RESOURCE_API ImportFollowup
{
...
class CORE_RESOURCE_API Metadata : public IObject
{
