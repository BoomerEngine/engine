...
// constant scalar editor
class EDITOR_MATERIAL_EDITOR_API MaterialGraphParameterNameSelector : public ui::IGraphNodeInnerWidget
{
    RTTI_DECLARE_VIRTUAL_CLASS(MaterialGraphParameterNameSelector, ui::IGraphNodeInnerWidget);
