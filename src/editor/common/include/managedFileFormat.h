...
struct EDITOR_COMMON_API ManagedFileTag
{
    StringBuf name;
    Color color;
    bool baked = false;
...
// format information
class EDITOR_COMMON_API ManagedFileFormat : public NoCopy
{
...
class EDITOR_COMMON_API ManagedFileFormatRegistry : public ISingleton
{
