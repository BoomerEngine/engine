...
class EDITOR_COMMON_API ManagedItem : public IObject
{
...
extern EDITOR_COMMON_API ManagedFile* SelectedFile();

// get the main selected depot file
extern EDITOR_COMMON_API Array<ManagedFile*> SelectedFiles();

// get selected directory
extern EDITOR_COMMON_API ManagedDirectory* SelectedDirectory();
