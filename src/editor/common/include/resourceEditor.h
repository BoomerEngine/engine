...
class EDITOR_COMMON_API ResourceEditor : public ui::DockPanel
{
...
class EDITOR_COMMON_API IResourceEditorAspect : public IObject
{
...
class EDITOR_COMMON_API IResourceEditorOpener : public NoCopy
{
