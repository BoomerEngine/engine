...
namespace ed
{
    ...
    /// editor edit mode
    class EDITOR_SCENE_EDITOR_API ISceneEditMode : public IObject
    {
    ...
    extern EDITOR_SCENE_EDITOR_API void CreateDefaultGridButtons(ScenePreviewContainer* container, ui::ToolBar* toolbar);

    // create default set of tools for selection
    extern EDITOR_SCENE_EDITOR_API void CreateDefaultSelectionButtons(ScenePreviewContainer* container, ui::ToolBar* toolbar);

    // create default set of tools for gizmos
    extern EDITOR_SCENE_EDITOR_API void CreateDefaultGizmoButtons(ScenePreviewContainer* container, ui::ToolBar* toolbar);

    // create default set of tools for object creation
    extern EDITOR_SCENE_EDITOR_API void CreateDefaultCreationButtons(ScenePreviewContainer* container, ui::ToolBar* toolbar);
