...
struct EDITOR_SCENE_EDITOR_API SceneLayoutViewportSettings
{
...
struct EDITOR_SCENE_EDITOR_API SceneLayoutSettings
{
...
/// grid settings
struct EDITOR_SCENE_EDITOR_API SceneGridSettings
{   
...
/// selection settings
struct EDITOR_SCENE_EDITOR_API SceneSelectionSettings
{
...
/// gizmo settings
struct EDITOR_SCENE_EDITOR_API SceneGizmoSettings
{
...
class EDITOR_SCENE_EDITOR_API ScenePreviewContainer : public ui::IElement
{
