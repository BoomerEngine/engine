...
class EDITOR_SCENE_EDITOR_API SceneCommonEditor : public ResourceEditor
{
    RTTI_DECLARE_VIRTUAL_CLASS(SceneCommonEditor, ResourceEditor);

public:
    SceneCommonEditor(const ResourceInfo& info, SceneContentNodeType rootContentType, StringView defaultEditorTag);
