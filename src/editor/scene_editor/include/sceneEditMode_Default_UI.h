...
struct EDITOR_SCENE_EDITOR_API SceneNodeTransformEntry
{
...
class EDITOR_SCENE_EDITOR_API ISceneNodeTransformValuesBoxEventSink : public NoCopy
{
public:
...
class EDITOR_SCENE_EDITOR_API SceneNodeTransformValuesBox : public ui::IElement
{
...
class EDITOR_SCENE_EDITOR_API SceneDefaultPropertyInspectorPanel : public ui::IElement, public ISceneNodeTransformValuesBoxEventSink
{
