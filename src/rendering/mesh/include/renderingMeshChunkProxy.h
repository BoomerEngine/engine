...
public:
	...
	void bind(GPUCommandWriter& cmd) const;

	// draw this chunk
	void draw(const GraphicsPipelineObject* pso, GPUCommandWriter& cmd, uint32_t numInstances = 1, uint32_t firstInstance = 0) const;
