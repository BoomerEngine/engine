...
namespace rendering
{
    namespace test
    {
        ...
        void RenderingTest_PointSize::render(command::CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* backBufferDepthView )
        {
            FrameBuffer fb;
