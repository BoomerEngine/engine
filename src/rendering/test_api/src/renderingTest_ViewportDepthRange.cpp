...
static void DrawGroup(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, float startX, float y, float startZ, float endZ, float size, uint32_t count, const base::Vector4& color)
{
...
void RenderingTest_ViewportDepthRange::render(GPUCommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* backBufferDepthView)
{
    FrameBuffer fb;
