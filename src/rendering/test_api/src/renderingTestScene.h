...
public:
    ...
    void draw(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, const SceneCamera& camera);
	void draw(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, const SceneCamera* cameras, uint32_t numCameras);
};
