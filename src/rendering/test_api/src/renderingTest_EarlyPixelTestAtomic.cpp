...
private:
    ...
    void renderLine(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, base::Color color) const;
    void renderQuad(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, float x, float y, float z, float w, float h, base::Color color) const;
};
...
void RenderingTest_EarlyPixelTestAtomic::renderLine(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, base::Color color) const
{
...
void RenderingTest_EarlyPixelTestAtomic::renderQuad(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, float x, float y, float z, float w, float h, base::Color color) const
{
...
void RenderingTest_EarlyPixelTestAtomic::render(GPUCommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* depth)
{
    FrameBuffer fb;
