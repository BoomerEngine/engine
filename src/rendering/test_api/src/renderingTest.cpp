...
void IRenderingTest::drawQuad(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, float x, float y, float w, float h, float u0, float v0, float u1, float v1, base::Color color)
{
...
void IRenderingTest::setQuadParams(GPUCommandWriter& cmd, float x, float y, float w, float h)
{
...
void IRenderingTest::setQuadParams(GPUCommandWriter& cmd, const RenderTargetView* rt, const base::Rect& rect)
{
...
void SimpleRenderMesh::drawChunk(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, uint32_t chunkIndex) const
{
...
void SimpleRenderMesh::drawMesh(GPUCommandWriter& cmd, const GraphicsPipelineObject* func) const
{
