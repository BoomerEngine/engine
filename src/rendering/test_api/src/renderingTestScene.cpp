...
void SimpleScene::draw(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, const SceneCamera& cameraParams)
{
	draw(cmd, func, &cameraParams, 1);
}

void SimpleScene::draw(GPUCommandWriter& cmd, const GraphicsPipelineObject* func, const SceneCamera* cameras, uint32_t numCameras)
{
