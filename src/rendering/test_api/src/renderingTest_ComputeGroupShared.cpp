...
void RenderingTest_ComputeGroupSharedMemory::render(GPUCommandWriter& cmd, float frameIndex, const RenderTargetView* backBufferView, const RenderTargetView* depth)
{
    // setup scene camera
    SceneCamera camera;
