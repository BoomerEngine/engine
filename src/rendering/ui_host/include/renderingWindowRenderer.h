...
class RENDERING_UI_HOST_API NativeWindowRenderer : public ui::IRendererNative, public INativeWindowCallback
{
...
public:
    ...
    virtual void windowRenderContent(ui::NativeWindowID id, const ui::ElementArea& area, bool forcedPaint, const base::canvas::Canvas& canvas) override;
