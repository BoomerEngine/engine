...
static void CollectCommandBuffers(GPUCommandBuffer* commandBuffer, base::Array<GPUCommandBuffer*>& outCommandBuffers)
{
	commandBuffer->visitHierarchy([&outCommandBuffers](GPUCommandBuffer* ptr)
		{
...
void BuildExecutionData(IBaseThread* drv, uint64_t cpuFrameIndex, PerformanceStats& outStats, GPUCommandBuffer* commandBuffer, FrameExecutionData& outData)
{
	...
	base::InplaceArray<GPUCommandBuffer*, 100> allCommandBuffers;
...
void IBaseThread::submit(GPUCommandBuffer* masterCommandBuffer)
{
