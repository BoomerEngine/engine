...
public:
	...
	void submit(GPUCommandBuffer* masterCommandBuffer);
	...
	// NOTE: called from render thread
	virtual void execute_Thread(uint64_t frameIndex, PerformanceStats& stats, GPUCommandBuffer* masterCommandBuffer, const FrameExecutionData& data) = 0;
