...
void FrameViewCaptureDepth::render(GPUCommandWriter& cmd)
{
...
void FrameViewCaptureDepth::initializeCommandStreams(GPUCommandWriter& cmd, FrameViewCaptureDepthRecorder& rec)
{
    // trigger capture
    ...
    // depth pre-pass
    {
        CommandWriterBlock block(cmd, "DepthFill");
