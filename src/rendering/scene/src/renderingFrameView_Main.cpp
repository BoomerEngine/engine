...
void FrameViewMain::render(GPUCommandWriter& cmd)
{
...
void FrameViewMain::initializeCommandStreams(GPUCommandWriter& cmd, FrameViewMainRecorder& rec)
{
    // view start 
    ...
    {
        CommandWriterBlock block(cmd, "GlobalShadowMask");
    ...
    // main forward pass
    {
        CommandWriterBlock block(cmd, "Forward");
        ...
        {
            CommandWriterBlock block(cmd, "Masked");
        ...
        {
            CommandWriterBlock block(cmd, "Transparent");
    ...
    {
        CommandWriterBlock block(cmd, "Outline");
    ...
    // overlay
    {
        CommandWriterBlock block(cmd, "Overlay");
    ...
    // screen pass
    {
        CommandWriterBlock block(cmd, "Screen");
...
void FrameViewMain::bindLighting(GPUCommandWriter& cmd)
{
    struct
    {
...
void FrameView_Main::render(GPUCommandWriter& parentCmd)
{
    ...
    {
        GPUCommandWriter cmd(parentCmd.opCreateChildCommandBuffer(), "MainFragments");
    ...
    // render passes
    {
        GPUCommandWriter cmd(parentCmd.opCreateChildCommandBuffer(), "MainView");
