...
void FrameViewWireframe::render(GPUCommandWriter& cmd)
{
...
void FrameViewWireframe::initializeCommandStreams(GPUCommandWriter& cmd, FrameViewWireframeRecorder& rec)
{
    // view start 
    ...
    // main forward pass
    {
        CommandWriterBlock block(cmd, "Wireframe");
