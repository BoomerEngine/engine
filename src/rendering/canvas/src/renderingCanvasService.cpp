...
void CanvasRenderAtlasImage::updateImage(GPUCommandWriter& cmd, const base::image::ImageView& sourceImage, uint8_t pageIndex, const base::Rect& dirtyRect)
{
...
void CanvasRenderAtlasImage::updateEntries(GPUCommandWriter& cmd, uint32_t firstEntry, uint32_t numEntries, const base::canvas::ImageAtlasEntryInfo* entiresData)
{
...
void CanvasRenderService::updateGlyphCache(rendering::GPUCommandWriter& cmd, const base::canvas::ICanvasAtlasSync::AtlasUpdate& update)
{
	if (!m_glyphCache)
...
void CanvasRenderService::updateAtlas(rendering::GPUCommandWriter& cmd, base::canvas::ImageAtlasIndex atlasIndex, const base::canvas::ICanvasAtlasSync::AtlasUpdate& update)
{
...
void CanvasRenderService::render(GPUCommandWriter& cmd, const base::canvas::Canvas& canvas)
{
