...
public:
	...
	virtual void render(GPUCommandWriter& cmd, const RenderData& data, uint32_t firstVertex, uint32_t numVertices) const = 0;
};
...
protected:
	...
	virtual void render(GPUCommandWriter& cmd, const RenderData& data, uint32_t firstVertex, uint32_t numVertices) const override;

	virtual const GraphicsPipelineObject* selectShader(GPUCommandWriter& cmd, const RenderData& data) const;
