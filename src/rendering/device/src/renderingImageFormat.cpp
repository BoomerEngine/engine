...
static ImageFormatInfo GImageFormatInfos[(uint8_t)ImageFormat::MAX] = {
	...
	{ "BC4_UNORM", "bc4", base::CompileTimeCRC32("BC4_UNORM").crc(), 1, 4, true, true, ImageFormatClass::UNORM },
	{ "BC5_UNORM", "bc5", base::CompileTimeCRC32("BC5_UNORM").crc(), 2, 8, true, true, ImageFormatClass::UNORM },
