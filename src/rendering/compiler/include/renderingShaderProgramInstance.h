...
class RENDERING_COMPILER_API ProgramConstants
{
public:
    ProgramConstants();
    ...
    INLINE const base::Array<ProgramInstanceParam>& constants() const { return m_constants; }
    ...
    const DataValue* findConstValue(base::StringID param) const;
    ...
    void calcCRC(base::CRC64& crc) const;
...
private:
    base::Array<ProgramInstanceParam> m_constants;
    uint64_t m_key = 0;
...
class RENDERING_COMPILER_API ProgramInstance
{
public:
