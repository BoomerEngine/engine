...
DataValueComponent::DataValueComponent(base::StringID name)
...
void DataValueComponent::print(base::IFormatStream& f) const
{
    switch (m_kind)
    {
...
void DataValueComponent::calcCRC(base::CRC64& outCRC) const
{
...
DataValue::DataValue(const base::Vector2& value)
{
...
DataValue::DataValue(const base::Vector3& value)
{
...
DataValue::DataValue(const base::Vector4& value)
{
...
DataValue::DataValue(base::StringID value)
{
    m_components.resize(1);
    m_components[0] = DataValueComponent(value);
}
...
void DataValue::calcCRC(base::CRC64& outCRC) const
{
...
namespace helper
{
    static void DumpScalars(base::StringBuilder& builder, DataType type, const DataValueComponent* components, const DataValueComponent* lastValidComponent)
    {
...
void DataValue::print(base::IFormatStream& builder) const
{
    if (m_components.empty())
    {
...
DataValueRef DataValueRef::compositeElement(const base::StringID name) const
{
...
void DataValueRef::print(base::IFormatStream& f) const
{
...
bool DataValueRef::writeValueWithMask(const DataValue& newValue, const ComponentMask& mask) const
{
    ...
    base::InplaceArray<uint8_t, 4> writeList;
