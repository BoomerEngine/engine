...
namespace base
{
    namespace image
    {
        ...
        static bool ConvertFormat(FIBITMAP* bitmap, base::image::PixelFormat& outFormat, uint8_t& outNumChannels)
        {
            auto width = FreeImage_GetWidth(bitmap);
            auto height = FreeImage_GetHeight(bitmap);
            auto bpp = FreeImage_GetBPP(bitmap);
            ...
            switch (type)
            {
                case FIT_BITMAP:
                {
                    ...
                    outFormat = base::image::PixelFormat::Uint8_Norm;
                    return true;
                }
                ...
                {
                    outNumChannels = 1;
                    outFormat = base::image::PixelFormat::Float32_Raw;
                    return true;
                }
                ...
                case FIT_UINT16:
                {
                    ...
                    outFormat = base::image::PixelFormat::Uint16_Norm;
                    return true;
                }
