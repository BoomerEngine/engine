...
namespace base
{
    namespace world
    {
        ...
        /// generic input event
        class BASE_WORLD_API EntityInputEvent
        {
        ...
        struct BASE_WORLD_API EntityCameraPlacement
        {
        ...
        class BASE_WORLD_API IEntityHelperStreamingDistanceResolver : public NoCopy
        {
        public:
        ...
        class BASE_WORLD_API Entity : public IObject
        {
            RTTI_DECLARE_POOL(POOL_WORLD_OBJECTS)
