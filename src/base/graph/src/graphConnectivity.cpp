...
namespace base
{
    namespace graph
    {
        ...
        void Connectivity::buildReachabilityList(const base::Array<Block*>& outputList, base::Array<Block*>& outList)
        {
            // reset helper data
            resetDepths();
        ...
        void Connectivity::resolveConnection(const Connection* con, const Socket* source, base::Array<Edge>& outEdges)
        {
            if (source)
            {
