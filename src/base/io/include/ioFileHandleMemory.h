...
namespace base
{
    namespace io
    {
        ...
        class BASE_IO_API MemoryReaderFileHandle : public IReadFileHandle
        {
        public:
        ...
        class BASE_IO_API MemoryAsyncReaderFileHandle : public IAsyncFileHandle
        {
        public:
        ...
        // an simple wrapper for file handle interface that allows read from memory block
        class BASE_IO_API MemoryWriterFileHandle : public IWriteFileHandle
        {
        public:
