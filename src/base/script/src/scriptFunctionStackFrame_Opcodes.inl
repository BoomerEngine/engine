...
namespace Opcodes
{
    ...
    DECLARE_OPCODE(ContextVar)
    {
        ...
        RETURN(void*, ::base::OffsetPtr(context, offset));
    }

    DECLARE_OPCODE(ContextExternalVar)
    {
        auto offset = Read<uint16_t>(stack);
        auto context  = (base::script::ScriptedObject*)stack->activeContext();
        auto data  = context->scriptedData();
        RETURN(void*, ::base::OffsetPtr(data, offset));
    }
    ...
    DECLARE_OPCODE(StructMemberRef)
    {
        ...
        RETURN(void*, ::base::OffsetPtr(refPtr, offset));
    }
