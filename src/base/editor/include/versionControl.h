...
namespace ed
{
    namespace vsc
    {
        ...
        /// file state
        struct BASE_EDITOR_API FileState
        {
        ...
        /// state of file locks
        struct BASE_EDITOR_API FileLocks
        {
            FileLocks();
        ...
        struct BASE_EDITOR_API Settings
        {
            Settings();
        ...
        struct BASE_EDITOR_API HistoryEntry
        {
            // when?
            io::TimeStamp m_time;
        ...
        class BASE_EDITOR_API IHostListener
        {
        public:
        ...
        class BASE_EDITOR_API IVersionControl
        {
