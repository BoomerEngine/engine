...
/// scrolling event
typedef std::function<void(const base::RefPtr<Scrollbar>& scrollbar)> TScrollEvent;

/// a simple scrollbar, consists of scroll thumb, buttons and few other shitty pieces
class BASE_UI_API Scrollbar : public IElement
{
...
private:
    ...
    base::RefPtr<ScrollbarThumb> m_thumb;
    base::RefPtr<Button> m_backwardButton;
    base::RefPtr<Button> m_forwardButton;
};

/// tracking element of the scrollbar
class BASE_UI_API ScrollbarThumb : public IElement
{
