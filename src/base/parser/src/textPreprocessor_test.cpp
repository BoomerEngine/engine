...
extern UniquePtr<ILanguageDefinition> BuildLanguage();

static ILanguageDefinition& GetTestLanguage()
{
    static UniquePtr<ILanguageDefinition> ret = BuildLanguage();
    return *ret;
}
...
TEST(Preprocessor, SimpleTokensPassthrough)
{
    ...
    TextFilePreprocessor test(allocator, IIncludeHandler::GetEmptyHandler(), IErrorReporter::GetDefault(), ICommentEater::StandardComments(), GetTestLanguage());
...
class HelperErrorReporter : public IErrorReporter
{
public:
...
TEST(Preprocessor, DefinieRedefinitionWarns)
{
    ...
    TextFilePreprocessor test(allocator, IIncludeHandler::GetEmptyHandler(), errorReporter, ICommentEater::StandardComments(), GetTestLanguage());
    ASSERT_TRUE(test.processContent(code, "TestFile"));
...
TEST(Preprocessor, IncludeForwardPath)
{
    ...
    mem::LinearAllocator allocator(POOL_TEMP);
    HelperErrorReporter errorReporter;
    TextFilePreprocessor test(allocator, includer, errorReporter, ICommentEater::StandardComments(), GetTestLanguage());
