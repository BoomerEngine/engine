...
TEST(VariantTest, CreateInt8)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<char>());
...
TEST(VariantTest, CreateInt16)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<short>());
...
TEST(VariantTest, CreateInt32)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<int>());
...
TEST(VariantTest, CreateInt64)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<int64_t>());
...
TEST(VariantTest, CreateUint8)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<uint8_t>());
...
TEST(VariantTest, CreateUint16)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<uint16_t>());
...
TEST(VariantTest, CreateUint32)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<uint32_t>());
...
TEST(VariantTest, CreateUint64)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<uint64_t>());
...
TEST(VariantTest, CreateBool)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<bool>());
...
TEST(VariantTest, CreateFloat)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<float>());
...
TEST(VariantTest, CreateDouble)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<double>());
...
TEST(VariantTest, CreateString)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<StringBuf>());
...
TEST(VariantTest, CreateStringID)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<StringID>());
...
{
    Variant a = CreateVariant<Vector3>(base::Vector3(1, 2, 3));
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<Vector3>());
...
TEST(VariantTest, CreateDynamicArray)
{
    ...
    ASSERT_TRUE(a.type() == base::reflection::GetTypeObject<Array<int>>());
...
TEST(VariantTest, CreateNestedVariants)
{
    ...
    ASSERT_TRUE(outer.type() == base::reflection::GetTypeObject<Variant>());

    const auto& str = *(const Variant*)outer.data();
    ASSERT_TRUE(str.type() == base::reflection::GetTypeObject<int>());
