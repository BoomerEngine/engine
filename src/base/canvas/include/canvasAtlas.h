...
namespace base
{
    namespace canvas
    {
		...
		public:
			...
			virtual void flush(rendering::command::CommandWriter& cmd, ICanvasAtlasSync& renderer) = 0;
		...
		private:
			...
			virtual void flush(rendering::command::CommandWriter& cmd, ICanvasAtlasSync& renderer) override final;
        };
