...
class BASE_NET_API RequestArgsGetterProxy : public NoCopy
{
public:
...
/// param list for HTTP post/get requests
class BASE_NET_API RequestArgsSetterProxy : public RequestArgsGetterProxy
{
public:
...
/// param list for HTTP post/get requests
class BASE_NET_API RequestArgs
{
public:
