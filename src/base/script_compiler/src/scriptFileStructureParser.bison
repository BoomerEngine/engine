...
using StubFlag = base::script::StubFlag;
using StubFlags = base::script::StubFlags;

static int bsc_lex(base::script::FileParsingNode* outNode, base::script::FileParsingContext& ctx, base::script::FileParsingTokenStream& tokens)
{
    return tokens.readToken(*outNode);
}

static int bsc_error(base::script::FileParsingContext& ctx, base::script::FileParsingTokenStream& tokens, const char* txt)
{
...
%define api.value.type {base::script::FileParsingNode}
%define parse.error verbose

%parse-param { base::script::FileParsingContext& context }
%parse-param { base::script::FileParsingTokenStream& tokens }

%lex-param { base::script::FileParsingContext& context }
%lex-param { base::script::FileParsingTokenStream& tokens }
...
function_operator_type
    : '+' { $$.location = $1.location; $$.name = base::StringID("opAdd"); }
    | '-' { $$.location = $1.location; $$.name = base::StringID("opSubtract"); }
    | '*' { $$.location = $1.location; $$.name = base::StringID("opMultiply"); }
    | '/' { $$.location = $1.location; $$.name = base::StringID("opDivide"); }
    | '%' { $$.location = $1.location; $$.name = base::StringID("opModulo"); }
    | '$' { $$.location = $1.location; $$.name = base::StringID("opDolar"); }
    | '#' { $$.location = $1.location; $$.name = base::StringID("opHash"); }
    | '@' { $$.location = $1.location; $$.name = base::StringID("opAt"); }
    | '^' { $$.location = $1.location; $$.name = base::StringID("opHat"); }
    | '!' { $$.location = $1.location; $$.name = base::StringID("opNot"); }
    | '~' { $$.location = $1.location; $$.name = base::StringID("opBinaryNot"); }
    | '&' { $$.location = $1.location; $$.name = base::StringID("opBinaryAnd"); }
    | '|' { $$.location = $1.location; $$.name = base::StringID("opBinaryOr"); }
    | '<' { $$.location = $1.location; $$.name = base::StringID("opLess"); }
    | '>' { $$.location = $1.location; $$.name = base::StringID("opGreater"); }
    | TOKEN_INC_OP { $$.location = $1.location; $$.name = base::StringID("opIncrement"); }
    | TOKEN_DEC_OP { $$.location = $1.location; $$.name = base::StringID("opDecrement"); }
    | TOKEN_LEFT_OP { $$.location = $1.location; $$.name = base::StringID("opShiftLeft"); }
    | TOKEN_RIGHT_OP { $$.location = $1.location; $$.name = base::StringID("opShiftRight"); }
    | TOKEN_RIGHT_RIGHT_OP { $$.location = $1.location; $$.name = base::StringID("opShiftRightUnsigned"); }
    | TOKEN_LE_OP { $$.location = $1.location; $$.name = base::StringID("opLessEqual"); }
    | TOKEN_GE_OP { $$.location = $1.location; $$.name = base::StringID("opGreaterEqual"); }
    | TOKEN_EQ_OP { $$.location = $1.location; $$.name = base::StringID("opEqual"); }
    | TOKEN_NE_OP { $$.location = $1.location; $$.name = base::StringID("opNotEqual"); }
    | TOKEN_AND_OP { $$.location = $1.location; $$.name = base::StringID("opLogicAnd"); }
    | TOKEN_OR_OP { $$.location = $1.location; $$.name = base::StringID("opLogicOr"); }
    | TOKEN_MUL_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opMulAssign"); }
    | TOKEN_DIV_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opDivAssign"); }
    | TOKEN_MOD_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opModAssign"); }
    | TOKEN_ADD_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opAddAssign"); }
    | TOKEN_SUB_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opSubAssign"); }
    | TOKEN_LEFT_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opShiftLeftAssign"); }
    | TOKEN_RIGHT_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opShiftRightAssign"); }
    | TOKEN_RIGHT_RIGHT_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opShiftRightUnsignedAssign"); }
    | TOKEN_AT_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opAtAssign"); }
    | TOKEN_HAT_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opHatAssign"); }
    | TOKEN_HASH_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opHashAssign"); }
    | TOKEN_DOLAR_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opDolarAssign"); }
    | TOKEN_AND_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opBinaryAndAssign"); }
    | TOKEN_OR_ASSIGN { $$.location = $1.location; $$.name = base::StringID("opBinaryOrAssign"); }
    ;       
   
function_body
    : ';' { $$.tokens.clear(); $$.flags = StubFlags(); $$.name = base::StringID(); }     
    | function_code '}' optional_semicolon { $$.flags = StubFlags(); $$.tokens = $1.tokens; $$.name = base::StringID(); }
...
type_ref_name
    : TOKEN_IDENT
    | type_ref_name '.' TOKEN_IDENT { $$.name = base::StringID(base::TempString("{}.{}", $1.name, $3.name)); }
    ; 
