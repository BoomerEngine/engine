...
namespace base
{
    namespace replication
    {
        ...
        void DataModel::buildFromFunction(const base::rtti::Function* functionType, DataModelRepository& repository)
        {
            // TODO
        }

        void DataModel::buildFromType(base::ClassType structType, DataModelRepository& repository)
        {
            // build model
