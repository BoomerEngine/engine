...
class GPU_DEVICE_API GraphicsRenderStatesObject : public IDeviceObject
{
...
class GPU_DEVICE_API GraphicsPipelineObject : public IDeviceObject
{
...
class GPU_DEVICE_API ComputePipelineObject : public IDeviceObject
{
