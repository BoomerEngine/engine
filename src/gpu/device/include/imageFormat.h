...
extern GPU_DEVICE_API const ImageFormatInfo& GetImageFormatInfo(ImageFormat format);
extern GPU_DEVICE_API bool GetImageFormatByDisplayName(StringView name, ImageFormat& outFormat);
extern GPU_DEVICE_API bool GetImageFormatByShaderName(StringView name, ImageFormat& outFormat);

extern GPU_DEVICE_API bool IsFormatValidForView(ImageFormat format);
extern GPU_DEVICE_API bool IsFormatValidForAtomic(ImageFormat format);
