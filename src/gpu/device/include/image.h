...
struct GPU_DEVICE_API ImageViewKey
{
    ...
    INLINE static uint32_t CalcHash(const ImageViewKey& key) { return CRC32() << key.key(); }
};
...
class GPU_DEVICE_API ImageSampledView : public IDeviceObjectView
{
...
class GPU_DEVICE_API ImageReadOnlyView : public IDeviceObjectView
{
...
class GPU_DEVICE_API ImageWritableView : public IDeviceObjectView
{
...
class GPU_DEVICE_API RenderTargetView : public IDeviceObjectView
{
...
class GPU_DEVICE_API ImageObject : public IDeviceObject
{
