...
class GPU_DEVICE_API IDeviceObject : public IReferencable
{
...
private:
    ...
    RefWeakPtr<IDeviceObjectHandler> m_impl;
};
...
class GPU_DEVICE_API IDeviceObjectView : public IReferencable
{
...
class GPU_DEVICE_API IDeviceObjectHandler : public IReferencable
{
public:
	...
	template< typename T >
	INLINE T* resolveInternalObject(ObjectID id) // gpu::api::IBaseObject
	{
...
class GPU_DEVICE_API SamplerObject : public IDeviceObject
{
