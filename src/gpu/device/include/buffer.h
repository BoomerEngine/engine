...
class GPU_DEVICE_API BufferObject : public IDeviceObject
{
...
class GPU_DEVICE_API BufferConstantView : public IDeviceObjectView
{
...
class GPU_DEVICE_API BufferView : public IDeviceObjectView
{
...
class GPU_DEVICE_API BufferStructuredView : public IDeviceObjectView
{
...
class GPU_DEVICE_API BufferWritableView : public IDeviceObjectView
{
...
class GPU_DEVICE_API BufferWritableStructuredView : public IDeviceObjectView
{
