...
void FrameBufferColorAttachmentInfo::print(IFormatStream& f) const
{
    if (empty())
    {
        f << "empty";
...
void FrameBufferDepthAttachmentInfo::print(IFormatStream& f) const
{
    if (empty())
    {
        f << "empty";
...
void FrameBuffer::print(IFormatStream& f) const
{
