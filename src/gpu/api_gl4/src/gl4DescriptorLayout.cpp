...
BEGIN_BOOMER_NAMESPACE_EX(gpu::api)
        namespace gl4
        {
            ...
            static uint32_t CountDescriptorElements(const Array<ShaderDescriptorMetadata>& descriptors)
            {
                uint32_t ret = 0;
            ...
            DescriptorBindingLayout::DescriptorBindingLayout(Thread* owner, const Array<ShaderDescriptorMetadata>& descriptors, const Array<ShaderStaticSamplerMetadata>& staticSamplers)
