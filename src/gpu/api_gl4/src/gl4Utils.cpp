...
ConfigProperty<bool> cvSupportSRGBTexture("Rendering.GL4", "EnableSRGBTextures", true);
...
uint8_t GetTextureFormatBytesPerPixel(GLenum format)
{
	...
	FATAL_ERROR(TempString("Unable to compute per-pixel size of format {}", format));
	return 0;
}
