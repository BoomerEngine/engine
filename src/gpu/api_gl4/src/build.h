...
extern GPU_API_GL4_API void ValidateResult(const char* testExpr, uint32_t line, const char* file);
...
#define GL_PROTECT(expr) { expr; boomer::gpu::api::gl4::ValidateResult(#expr, __LINE__, __FILE__); }
#else
