...
enum class CompositePackingRules : uint8_t
{
    ...
    Std140, // strict shader rules (old s, array elements are forced to 16 bytes alignment, float3 takes 16 bytes, etc)
    Std430, // relaxed shader rules (new s, array elements are using 4 bytes alignment), default for structures
};
