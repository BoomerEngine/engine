...
extern GPU_SHADER_COMPILER_API const parser::ILanguageDefinition& GetShaderLanguageDefinition();

/// analyze structure of the shader file
/// NOTE: all memory is allocated from the linear allocator
extern GPU_SHADER_COMPILER_API Element* AnalyzeShaderFile(mem::LinearAllocator& mem, parser::IErrorReporter& errHandler, parser::TokenList& tokens);

/// analyze structure of the shader function
extern GPU_SHADER_COMPILER_API CodeNode* AnalyzeShaderCode(mem::LinearAllocator& mem, parser::IErrorReporter& errHandler, const Array<parser::Token*>& tokens, const CodeLibrary& lib, const Function* contextFunction, const Program* contextProgram);
