...
#include "build.h"
#include "gpu/shader_compiler/src/renderingShaderFileParserHelper.h"
...
static int cslf_lex(boomer::gpu::compiler::ParsingNode* outNode, boomer::gpu::compiler::ParsingFileContext& ctx, boomer::gpu::compiler::ParserTokenStream& tokens)
{
    return tokens.readToken(*outNode);
}

static int cslf_error(boomer::gpu::compiler::ParsingFileContext& ctx, boomer::gpu::compiler::ParserTokenStream& tokens, const char* txt)
{
...
%define api.value.type {boomer::gpu::compiler::ParsingNode}
%define parse.error verbose

%parse-param { boomer::gpu::compiler::ParsingFileContext& context }
%parse-param { boomer::gpu::compiler::ParserTokenStream& tokens }

%lex-param { boomer::gpu::compiler::ParsingFileContext& context }
%lex-param { boomer::gpu::compiler::ParserTokenStream& tokens }
