...
const DataValue* ProgramConstants::findConstValue(StringID name) const
{
...
void ProgramConstants::calcCRC(CRC64& crc) const
{
...
void ProgramConstants::print(IFormatStream& f) const
{
    bool addComa = false;
