...
using ParsingNode = boomer::gpu::compiler::ParsingNode;
using Element = boomer::gpu::compiler::Element;
using ElementType = boomer::gpu::compiler::ElementType;
using TypeReference = boomer::gpu::compiler::TypeReference;
using ElementFlags = boomer::gpu::compiler::ElementFlags;
using ElementFlag = boomer::gpu::compiler::ElementFlag;
using CodeNode = boomer::gpu::compiler::CodeNode;
using DataType = boomer::gpu::compiler::DataType;
using DataValue = boomer::gpu::compiler::DataValue;
using OpCode = boomer::gpu::compiler::OpCode;

static int cslc_lex(boomer::gpu::compiler::CodeParsingNode* outNode, boomer::gpu::compiler::ParsingCodeContext& ctx, boomer::gpu::compiler::ParserCodeTokenStream& tokens)
{
    return tokens.readToken(*outNode);
}

static int cslc_error(boomer::gpu::compiler::ParsingCodeContext& ctx, boomer::gpu::compiler::ParserCodeTokenStream& tokens, const char* txt)
{
...
%define api.value.type {boomer::gpu::compiler::CodeParsingNode}
%define parse.error verbose

%parse-param { boomer::gpu::compiler::ParsingCodeContext& context }
%parse-param { boomer::gpu::compiler::ParserCodeTokenStream& tokens }

%lex-param { boomer::gpu::compiler::ParsingCodeContext& context }
%lex-param { boomer::gpu::compiler::ParserCodeTokenStream& tokens }
...
variable_declaration
    : TOKEN_IDENT variable_init
    {
        ...
        $$.m_code->extraData().m_name = boomer::StringID($1.m_string);
...
postfix_expression
	...
	| postfix_expression '.' ident_like
	{
	    ...
	    $$.m_code->extraData().m_name = boomer::StringID($3.m_string);
