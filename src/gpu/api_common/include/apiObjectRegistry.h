...
class GPU_API_COMMON_API ObjectRegistry : public IDeviceObjectHandler // external client proxies have have weak referencs to this
{
...
private:
    ...
    Mutex m_lock; // may be called from threads
