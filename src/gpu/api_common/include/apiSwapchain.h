...
struct GPU_API_COMMON_API SwapchainState
{
	uint32_t width = 0;
	uint32_t height = 0;
	uint8_t samples = 0;
...
class GPU_API_COMMON_API IBaseSwapchain : public NoCopy
{
public:
...
// NOTE: this object MUST be deleted on render thread
class GPU_API_COMMON_API IBaseWindowedSwapchain : public IBaseSwapchain
{
public:
	struct WindowSetup
	{
