...
class GPU_API_COMMON_API IBaseShaders : public IBaseObject
{
public:
	...
	INLINE const Buffer& sourceData() const { return m_sourceData; }
...
class GPU_API_COMMON_API ShadersObjectProxy : public ShaderObject
{
public:
...
private:
	...
	HashMap<uint64_t, RefWeakPtr<GraphicsPipelineObject>> m_pipelineObjectMap;
	RefWeakPtr<ComputePipelineObject> m_compilePipelineObject;
};
