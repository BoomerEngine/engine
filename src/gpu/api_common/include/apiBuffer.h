...
// base buffer view
class GPU_API_COMMON_API IBaseBufferView : public IBaseObject
{
public:
	struct Setup
	{
...
// buffer object
class GPU_API_COMMON_API IBaseBuffer : public IBaseCopiableObject
{
public:
...
class GPU_API_COMMON_API BufferObjectProxy : public BufferObject
{
public:
