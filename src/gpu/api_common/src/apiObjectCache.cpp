...
IBaseVertexBindingLayout::IBaseVertexBindingLayout(IBaseObjectCache* cache, const Array<ShaderVertexStreamMetadata>& streams)
	: m_elements(streams)
{
...
void IBaseVertexBindingLayout::print(IFormatStream& f) const
{
...
IBaseDescriptorBindingLayout::IBaseDescriptorBindingLayout(const Array<ShaderDescriptorMetadata>& descriptors)
...
void IBaseDescriptorBindingLayout::print(IFormatStream& f) const
{
...
uint16_t IBaseObjectCache::resolveVertexBindPointIndex(StringID name)
{
    uint16_t ret = 0;
...
uint16_t IBaseObjectCache::resolveDescriptorBindPointIndex(StringID name, DescriptorID layout)
{
