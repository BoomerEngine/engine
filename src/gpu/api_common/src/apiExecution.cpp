...
void GeometryBufferBinding::print(IFormatStream& f) const
{
	if (id)
...
void GeometryStates::print(IFormatStream& f) const
{
...
void DescriptorBinding::print(IFormatStream& f) const
{
	if (dataPtr)
...
void DescriptorState::print(IFormatStream& f) const
{
...
void PassAttachmentBinding::print(IFormatStream& f) const
{
	if (viewId)
...
void PassState::print(IFormatStream& f) const
{
...
void IFrameExecutor::runNop(const OpNop& op)
{
}

void IFrameExecutor::runHello(const OpHello& op)
{
}

void IFrameExecutor::runNewBuffer(const OpNewBuffer& op)
{
}

void IFrameExecutor::runTriggerCapture(const OpTriggerCapture& op)
{
}

void IFrameExecutor::runAcquireOutput(const OpAcquireOutput& op)
{
...
void IFrameExecutor::runSwapOutput(const OpSwapOutput& op)
{
	ASSERT(m_activeSwapchain);
...
void IFrameExecutor::runChildBuffer(const OpChildBuffer& op)
{
...
void IFrameExecutor::runUploadConstants(const OpUploadConstants& op)
{
	// nothing here, this op is placeholder
}

void IFrameExecutor::runUploadDescriptor(const OpUploadDescriptor& op)
{
	// nothing here, this op is placeholder
}
...
void IFrameExecutor::runBindVertexBuffer(const OpBindVertexBuffer& op)
{
	if (op.bindpoint)
	{
...
void IFrameExecutor::runBindIndexBuffer(const OpBindIndexBuffer& op)
{
...
void IFrameExecutor::runBindDescriptor(const OpBindDescriptor& op)
{
	ASSERT(op.binding);
	ASSERT(op.layout);
...
void IFrameExecutor::runUpdate(const OpUpdate& op)
{
...
void IFrameExecutor::runCopy(const OpCopy& op)
{
...
void IFrameExecutor::runBeginPass(const OpBeginPass& op)
{
...
void IFrameExecutor::runEndPass(const OpEndPass& op)
{
