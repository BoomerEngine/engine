...
void RenderingTest_MultiTexture::initialize()
{
	switch (subTestIndex())
	{
		case 0:
			...
			m_textureD = createChecker2D(512, 8, false, Color::RED, Color::BLUE)->createSampledView();
			break;
...
void RenderingTest_MultiTexture::render(CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* depth)
{
    FrameBuffer fb;
