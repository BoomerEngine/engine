...
void RenderingTest_FormatBufferWrite::initialize()
{
    ...
    m_tempBuffer = createStorageBuffer(2 * sizeof(Vector4) * MAX_ELEMENTS);
...
void RenderingTest_FormatBufferWrite::render(CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* depth)
{
    FrameBuffer fb;
