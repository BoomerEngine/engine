...
void RenderingTest_SampleMask::initialize()
{
	...
	m_shaderGenerate = loadGraphicsShader(TempString("SampleMaskGenerate{}.csl", subTestIndex()));
}

void RenderingTest_SampleMask::render(CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* depth)
{
