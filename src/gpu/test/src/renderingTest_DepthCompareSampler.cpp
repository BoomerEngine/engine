...
#include "../../device/include/globalObjects.h"
...
void RenderingTest_DepthCompareSampler::render(CommandWriter& cmd, float time, const RenderTargetView* backBufferView, const RenderTargetView* backBufferDepthView)
{
    ...
    // draw the depth compare test
    {
		...
		tempParams[1] = gpu::Globals().SamplerPointDepthLE;
