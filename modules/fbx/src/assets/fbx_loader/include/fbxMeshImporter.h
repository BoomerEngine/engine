...
namespace fbx
{
    ...
    class ASSETS_FBX_LOADER_API FBXMeshImportConfig : public rendering::MeshImportConfig
    {
    ...
    class ASSETS_FBX_LOADER_API MeshImporter : public base::res::IResourceImporter
    {
