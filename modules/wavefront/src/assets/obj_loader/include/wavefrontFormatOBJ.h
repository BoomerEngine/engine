...
namespace wavefront
{
    ...
    /// OBJ format face
    struct ASSETS_OBJ_LOADER_API Face
    {
    ...
    /// Material reference
    struct ASSETS_OBJ_LOADER_API MaterialRef
    {
    ...
    struct ASSETS_OBJ_LOADER_API GroupChunk
    {
    ...
    /// OBJ group
    struct ASSETS_OBJ_LOADER_API Group
    {
    ...
    /// OBJ object
    struct ASSETS_OBJ_LOADER_API Object
    {
