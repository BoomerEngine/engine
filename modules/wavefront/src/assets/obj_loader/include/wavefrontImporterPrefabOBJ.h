...
namespace wavefront
{
    ...
    class ASSETS_OBJ_LOADER_API OBJPrefabImportConfig : public rendering::MeshImportConfig
    {
    ...
    class ASSETS_OBJ_LOADER_API OBJPrefabImporter : public base::res::IResourceImporter
    {
