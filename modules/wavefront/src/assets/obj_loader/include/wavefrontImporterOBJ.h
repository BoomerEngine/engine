...
namespace wavefront
{
    ...
    class ASSETS_OBJ_LOADER_API OBJMeshImportConfig : public rendering::MeshImportConfig
    {
    ...
    class ASSETS_OBJ_LOADER_API OBJMeshImporter : public base::res::IResourceImporter
    {
