...
namespace game
{
    ...
    void Entity::requestTransform(const base::AbsoluteTransform& newTransform)
    {
        if (m_world)
        {
            m_flags |= EntityFlagBit::DirtyTransform;
    ...
    void Entity::requestMove(const base::AbsolutePosition& newPosition)
    {
    ...
    void Entity::requestMove(const base::AbsolutePosition& newPosition, const base::Quat& newRotation)
    {
        auto transform = m_absoluteTransform;
        transform.position(newPosition);
    ...
    void Entity::handleTransformUpdate(const base::AbsoluteTransform& transform)
    {
