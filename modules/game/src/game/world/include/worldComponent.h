...
namespace game
{
    ...
    class IComponentLink : public base::IObject
    {
        RTTI_DECLARE_VIRTUAL_CLASS(IComponentLink, base::IObject);
    ...
    public:
        ...
        virtual void calculateNewAbsoluteTransform(const base::Transform& componentRelativeTransform, ComponentFlags componentFlags, const base::AbsoluteTransform& parentTransform, const base::Matrix& parentToWorld,   base::AbsoluteTransform& outNewAbsoluteTransform, base::Matrix& outNewLocalToWorldMatrix) const;
    };
    ...
    public:
        ComponentTransformLinkEx(Component* source, Component* target, const base::Transform& relativeTransform, bool updateRotation, bool updateScale);

        // calculate new absolute transform for component
        virtual void calculateNewAbsoluteTransform(const base::Transform& componentRelativeTransform, ComponentFlags componentFlags, const base::AbsoluteTransform& parentTransform, const base::Matrix& parentToWorld, base::AbsoluteTransform& outNewAbsoluteTransform, base::Matrix& outNewLocalToWorldMatrix) const override final;

    private:
        base::Transform m_additionalTransform;
    ...
    class GAME_WORLD_API Component : public base::script::ScriptedObject
    {
    ...
    public:
        ...
        INLINE const base::Transform& relativeTransform() const { return m_relativeTransform; }
        ...
        virtual void handleTransformUpdate(const Component* source, const base::AbsoluteTransform& parentTransform, const base::Matrix& parentToWorld);
        ...
        void relativeTransform(const base::Transform& newTransform);
        ...
        ComponentTransformLinkPtr linkTransformEx(Component* transformSource, base::Transform& relativeTransform, bool updateRotation=true, bool updateScale=true);
    ...
    private:
        ...
        base::Transform m_relativeTransform;
        ...
        struct LinksData
        {
            ...
            base::Array<ComponentTransformLink*> m_outgoingTransformLinks;

            base::Array<ComponentLinkPtr> m_incomingLinks;
            base::Array<ComponentLinkPtr> m_outgoingLinks;
        };

        base::UniquePtr<LinksData> m_links;
        ...
        void recalculateTransform(const base::AbsoluteTransform& parentTransform, const base::Matrix& parentToWorld);
