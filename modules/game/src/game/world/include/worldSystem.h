...
namespace game
{
    ...
    class GAME_WORLD_API IWorldSystem : public base::script::ScriptedObject
    {
    ...
    class GAME_WORLD_API DependsOnWorldSystemMetadata : public base::rtti::IMetadata
    {
    ...
    class GAME_WORLD_API TickOrderWorldSystemMetadata : public base::rtti::IMetadata
    {
