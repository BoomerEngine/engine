...
namespace game
{
    ...
    class GAME_SCENE_API ComponentDataTemplate : public base::ObjectTemplate
    {
    ...
    public:
        ...
        ComponentDataTemplatePtr copy() const;
    ...
    class GAME_SCENE_API EntityDataTemplate : public base::ObjectTemplate
    {
    ...
    public:
        ...
        EntityDataTemplatePtr copy() const;
    ...
    struct GAME_SCENE_API NodeTemplatePrefabSetup
    {
    ...
    class GAME_SCENE_API NodeTemplate : public base::IObject
    {
    ...
    public:
        ...
        INLINE const EntityDataTemplatePtr& entityTemplate() const { return m_entityTemplate; }

        /// get template for components
        INLINE const base::Array<ComponentDataTemplatePtr>& componentTemplates() const { return m_componentTemplates; }
        ...
        /// make a copy (way faster and safer than clone)
        NodeTemplatePtr copy() const;
    ...
    private:
        ...
        // entity template
        EntityDataTemplatePtr m_entityTemplate;

        // component templates
        base::Array<ComponentDataTemplatePtr> m_componentTemplates;
