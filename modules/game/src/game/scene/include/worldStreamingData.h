...
namespace game
{
    ...
    class GAME_SCENE_API WorldSectorUnpackedData : public base::IReferencable
    {
    public:
    ...
    class GAME_SCENE_API WorldSectorData : public base::IObject
    {
    ...
    class GAME_SCENE_API WorldSectorGridLevel : public base::IObject
    {
    ...
    /// Baked world sectors
    class GAME_SCENE_API WorldSectors : public base::res::IResource
    {
