...
namespace rendering
{
    namespace gl4
    {
        ...
        ExecutorStateTracker::RenderDirtyStateTrack& ExecutorStateTracker::RenderDirtyStateTrack::operator|=(const RenderDirtyStateTrack& other)
        {
            flags |= other.flags;
        ...
        ExecutorStateTracker::RenderDirtyStateTrack ExecutorStateTracker::RenderDirtyStateTrack::ALL_STATES()
        {
        ...
        void ExecutorStateTracker::RenderStates::apply(RenderDirtyStateTrack statesToApply) const
        {
        ...
        const ExecutorStateTracker::RenderStates ExecutorStateTracker::GDefaultState;
...
#define DEBUG_CHECK_PASS_ONLY() \
        ...
        void ExecutorStateTracker::runSetViewportRect(const command::OpSetViewportRect& op)
        {
        ...
        void ExecutorStateTracker::runSetViewportDepthRange(const command::OpSetViewportDepthRange& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetScissorRect(const command::OpSetScissorRect& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetScissorState(const command::OpSetScissorState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetStencilReference(const command::OpSetStencilReference& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetStencilWriteMask(const command::OpSetStencilWriteMask& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetStencilCompareMask(const command::OpSetStencilCompareMask& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        bool ExecutorStateTracker::SetStencilFunc(RenderStates::ResolvedStencilFaceState& face, const StencilSideState& op)
        {
        ...
        bool ExecutorStateTracker::SetStencilWriteMask(RenderStates::ResolvedStencilFaceState& face, const StencilSideState& op)
        {
        ...
        bool ExecutorStateTracker::SetStencilOps(RenderStates::ResolvedStencilFaceState& face, const StencilSideState& op)
        {
        ...
        void ExecutorStateTracker::runSetStencilState(const command::OpSetStencilState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetDepthBiasState(const command::OpSetDepthBiasState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetFillState(const command::OpSetFillState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetPrimitiveAssemblyState(const command::OpSetPrimitiveAssemblyState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetCullState(const command::OpSetCullState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetBlendColor(const command::OpSetBlendColor& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::updateBlendingEnable()
        {
        ...
        void ExecutorStateTracker::runSetBlendState(const command::OpSetBlendState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetDepthClipState(const command::OpSetDepthClipState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetDepthState(const command::OpSetDepthState& op)
        {
            DEBUG_CHECK_PASS_ONLY();
        ...
        void ExecutorStateTracker::runSetMultisampleState(const command::OpSetMultisampleState& op)
        {
        ...
        void ExecutorStateTracker::runSetColorMask(const command::OpSetColorMask& op)
        {
            DEBUG_CHECK_PASS_ONLY();
            DEBUG_CHECK_EX(op.rtIndex < m_pass.colorCount, "Render target was not enabled in pass");
        ...
        void ExecutorStateTracker::resetCommandBufferRenderState()
        {
        ...
        void ExecutorStateTracker::applyDirtyRenderStates()
        {
